			    	...
			    	<ul class="slides">
				     	...
				     	<!-- SLIDE #1 -->
				      	<li id="slide-1">
					        ...
					        <!-- Background Image -->
				        	<img src="/assets/images/slider/slide-1.jpg" alt="slide-background">
				      	...
				      	<li id="slide-2">
				        	...
				        	<!-- Background Image -->
				        	<img src="/assets/images/slider/slide-2.jpg" alt="slide-background">
				     	...
				     	<!-- SLIDE #3 -->
				      	<li id="slide-3">
				      		...
				      		<!-- Background Image -->
				        	<img src="/assets/images/slider/slide-3.jpg" alt="slide-background">
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5 col-lg-6">
							<div class="about-3-img text-center mb-40">
								<img class="img-fluid" src="/assets/images/about-03-img.png" alt="about-image">
							</div>
						</div>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-11.jpg" class="image-link">
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Crispy Chicken</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-12.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Ultimate Bacon</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-13.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Black Sheep</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-14.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Double Burger</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/menu/burger-15.jpg" alt="menu-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-15.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/menu/burger-16.jpg" alt="menu-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-16.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Smokey House</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/menu/burger-17.jpg" alt="menu-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-17.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Classic Burger</h5>
							...
							<div class="menu-6-item bg-white">
								...
								<div class="menu-6-img rel">
									<div class="hover-overlay">
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/menu/burger-18.jpg" alt="menu-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/menu/burger-18.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
								...
								<div class="menu-6-txt rel">
									...
									<!-- Title -->
									<h5 class="h5-sm coffee-color">Vegan Burger</h5>
							...
							<div class="pbox-8 row d-flex align-items-center">
								...
								<div id="pb-8-1" class="col-lg-6">
									<div class="pbox-8-txt">
										...
										<!-- Title -->		
										<h5 class="h5-sm coffee-color"><a href="product-single.html">Tuna Salad</a></h5>
							...
							<div class="pbox-8 row d-flex align-items-center">
								...
								<div id="pb-8-2" class="col-lg-6">
									<div class="pbox-8-txt">
										...
										<!-- Title -->		
										<h5 class="h5-sm coffee-color"><a href="product-single.html">Crispy Chicken</a></h5>
							...
							<div class="pbox-8 row d-flex align-items-center pbox-8-last">
								...
								<div id="pb-8-3" class="col-lg-6">
									<div class="pbox-8-txt">
										...
										<!-- Title -->		
										<h5 class="h5-sm coffee-color"><a href="product-single.html">Egg Sandwich</a></h5>
							...
							<div class="pbox-7 clearfix">
								...
								<div class="pbox-7-img rel">
									<div class="hover-overlay"> 	
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/img-01.jpg" alt="promo-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/img-01.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
							...
							<div class="pbox-7 clearfix m-row">
								...
								<div class="pbox-7-img rel m-top">
									<div class="hover-overlay"> 	
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/img-02.jpg" alt="promo-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/img-02.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
							...
							<div class="pbox-7 clearfix">
								...
								<div class="pbox-7-img rel">
									<div class="hover-overlay"> 
										...
										<!-- Image -->
										<img class="img-fluid" src="/assets/images/img-03.jpg" alt="promo-image" />
										...
										<!-- Zoom Icon -->
										<div class="menu-img-zoom ico-25">
											<a href="/assets/images/img-03.jpg" class="image-link">
												<span class="flaticon-zoom"></span>
											</a>
										</div> 
				...
				<div class="container">
					...
					<div class="row">
						...
						<!-- IMAGE #1 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-01.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #2 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-02.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #3 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-03.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #4 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-04.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #5 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-05.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #6 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-06.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #7 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-07.jpg" class="image-link">
									<div class="hover-overlay"> 
						...
						<!-- IMAGE #8 -->
					  	<div class="col-sm-6 col-lg-3">
					  		<div class="gallery-img">
						  		<a href="/assets/images/gallery/img-08.jpg" class="image-link">
									<div class="hover-overlay"> 
